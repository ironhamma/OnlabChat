...
<html lang="en">
<head>
    <title>Code coverage report for server-methods.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> server-methods.js
    </h1>
    <div class='clearfix'>
...
module.exports = {
   ...
   */
  clientCredentialsGrant: <span class="fstat-no" title="function not covered" >fu</span>nction(options, callback) {
<span class="cstat-no" title="statement not covered" >    return AuthenticationRequest.builder()</span>
      .withPath('/api/token')
      .withBodyParameters({
...
&nbsp;
   ...
   */
  authorizationCodeGrant: <span class="fstat-no" title="function not covered" >fu</span>nction(code, callback) {
<span class="cstat-no" title="statement not covered" >    return AuthenticationRequest.builder()</span>
      .withPath('/api/token')
      .withBodyParameters({
