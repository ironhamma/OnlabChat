...
<html lang="en">
<head>
    <title>Code coverage report for spotify-web-api.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> spotify-web-api.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">84.54% </span>
        <span class="quiet">Functions</span>
        <span class='fraction'>82/97</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">88.05% </span>
...
<a name='L1589'></a><a href='#L1589'>1589</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
SpotifyWebApi.prototype = {
  setCredentials: <span class="fstat-no" title="function not covered" >fu</span>nction(credentials) {
<span class="cstat-no" title="statement not covered" >    for (var key in credentials) {</span>
<span class="cstat-no" title="statement not covered" >      if (credentials.hasOwnProperty(key)) {</span>
<span class="cstat-no" title="statement not covered" >        this._credentials[key] = credentials[key];</span>
      }
    }
  },
&nbsp;
...
&nbsp;
  resetCredentials: <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >    this._credentials = null;</span>
  },
&nbsp;
...
&nbsp;
  setRefreshToken: <span class="fstat-no" title="function not covered" >fu</span>nction(refreshToken) {
<span class="cstat-no" title="statement not covered" >    this._setCredential('refreshToken', refreshToken);</span>
  },
&nbsp;
  setRedirectURI: <span class="fstat-no" title="function not covered" >fu</span>nction(redirectUri) {
<span class="cstat-no" title="statement not covered" >    this._setCredential('redirectUri', redirectUri);</span>
  },
&nbsp;
...
&nbsp;
  resetAccessToken: <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >    this._resetCredential('accessToken');</span>
  },
&nbsp;
  resetRefreshToken: <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >    this._resetCredential('refreshToken');</span>
  },
&nbsp;
  resetRedirectURI: <span class="fstat-no" title="function not covered" >fu</span>nction() {
<span class="cstat-no" title="statement not covered" >    this._resetCredential('redirectUri');</span>
  },
&nbsp;
  _setCredential: function(credentialKey, value) {
    this._credentials = this._credentials || <span class="branch-1 cbranch-no" title="branch not covered" >{};</span>
    this._credentials[credentialKey] = value;
  },
&nbsp;
  _getCredential: function(credentialKey) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._credentials) {
...
&nbsp;
   ...
   */
  getPlaylistTracks: <span class="fstat-no" title="function not covered" >fu</span>nction(userId, playlistId, options, callback) {
<span class="cstat-no" title="statement not covered" >    return WebApiRequest.builder(this.getAccessToken())</span>
      .withPath(
        '/v1/users/' +
...
&nbsp;
   ...
   * it contains an error object. Not returned if a callback is given.
   */
  uploadCustomPlaylistCoverImage: <span class="fstat-no" title="function not covered" >fu</span>nction(
    userId,
    playlistId,
    base64URI,
    callback
...
&nbsp;
   ...
   * it contains an error object. Not returned if a callback is given.
   */
  removeTracksFromPlaylist: <span class="fstat-no" title="function not covered" >fu</span>nction(
    userId,
    playlistId,
    tracks,
    options,
...
&nbsp;
   ...
   * it contains an error object. Not returned if a callback is given.
   */
  replaceTracksInPlaylist: <span class="fstat-no" title="function not covered" >fu</span>nction(userId, playlistId, uris, callback) {
<span class="cstat-no" title="statement not covered" >    return WebApiRequest.builder(this.getAccessToken())</span>
      .withPath(
        '/v1/users/' +
          encodeURIComponent(userId) +
...
&nbsp;
   ...
   *          rejected, it contains an error object. Not returned if a callback is given.
   */
  getAudioAnalysisForTrack: <span class="fstat-no" title="function not covered" >fu</span>nction(trackId, callback) {
<span class="cstat-no" title="statement not covered" >    return WebApiRequest.builder(this.getAccessToken())</span>
...
&nbsp;
  ...
  getRecommendations: function(options, callback) {
    ...
    for (var option in options) {
      <span class="missing-if-branch" title="else path not taken" >E</span>if (options.hasOwnProperty(option)) {
        if (
...
&nbsp;
   ...
   */
  getMySavedTracks: <span class="fstat-no" title="function not covered" >fu</span>nction(options, callback) {
<span class="cstat-no" title="statement not covered" >    return WebApiRequest.builder(this.getAccessToken())</span>
...
&nbsp;
   ...
   */
  containsMySavedTracks: <span class="fstat-no" title="function not covered" >fu</span>nction(trackIds, callback) {
<span class="cstat-no" title="statement not covered" >    return WebApiRequest.builder(this.getAccessToken())</span>
...
&nbsp;
   ...
   *          otherwise an error. Not returned if a callback is given.
   */
  getMyCurrentPlayingTrack: <span class="fstat-no" title="function not covered" >fu</span>nction(options, callback) {
<span class="cstat-no" title="statement not covered" >    return WebApiRequest.builder(this.getAccessToken())</span>
...
&nbsp;
  ...
  setRepeat: function(options, callback) {
    return WebApiRequest.builder(this.getAccessToken())
      ...
      .withQueryParameters({
        state: options.state || <span class="branch-1 cbranch-no" title="branch not covered" >'off'</span>
      })
      .build()
      .execute(HttpManager.put, callback);
  },
&nbsp;
  ...
  setShuffle: function(options, callback) {
    return WebApiRequest.builder(this.getAccessToken())
      ...
      .withQueryParameters({
        state: options.state || <span class="branch-1 cbranch-no" title="branch not covered" >'false'</span>
      })
      .build()
      .execute(HttpManager.put, callback);
  },
&nbsp;
  ...
  setVolume: function(volumePercent, options, callback) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (options &amp;&amp; 'device_id' in options) {
      /* jshint camelcase: false */
      params.device_id = options.device_id;
    }
    return WebApiRequest.builder(this.getAccessToken())
...
SpotifyWebApi._addMethods = function(methods) {
  for (var i in methods) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (methods.hasOwnProperty(i)) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Sat Apr 28 2018 14:35:07 GMT+0200 (CEST)
</div>
</div>
