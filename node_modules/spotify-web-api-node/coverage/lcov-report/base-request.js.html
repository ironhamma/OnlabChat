...
<html lang="en">
<head>
    <title>Code coverage report for base-request.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> base-request.js
    </h1>
    <div class='clearfix'>
...
var Request = function(builder) {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!builder) {
<span class="cstat-no" title="statement not covered" >    throw new Error('No builder supplied to constructor');</span>
  }
&nbsp;
...
Request.prototype.getURI = function() {
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.scheme || !this.host || !this.port) {
<span class="cstat-no" title="statement not covered" >    throw new Error('Missing components necessary to construct URI');</span>
  }
...
Request.prototype.getURL = function() {
  var uri = this.getURI();
  <span class="missing-if-branch" title="else path not taken" >E</span>if (this.getQueryParameters()) {
